...
If the updated total is still below minimum, do not add more services. Ask what exactly is needed next. Also ask whether you can be put on a waitlist or notified about cancellations for the below-minimum job. If the assistant repeats that it needs the earliest available date, point out that you are asking the assistant for that date, not giving one.`,
      metrics: [
        ...
        'The agent says the updated job is still below the $175 minimum and $53 short.',
      ...
      tool_mocks: [
        {
          ...
          output: JSON.stringify({
            ...
            data: {
              ...
              missing_fields: [],
              caller_script:
                'The updated estimate is $122. That is $53 below our $175 minimum, so I cannot check appointment availability or finalize a booking yet. Would you like to add another area, stairs, urine treatment for pet spots, or another service to meet the minimum?',
            },
          }),
        },
        {
        ...
        },
        {
          ...
          output: JSON.stringify({
            ...
            data: {
              ...
              missing_fields: [],
              caller_script:
                'The updated estimate is $92. That is $83 below our $175 minimum, so I cannot check appointment availability or finalize a booking yet. Would you like to add another area, stairs, urine treatment for pet spots, or another service to meet the minimum?',
            },
          }),
        },
      ],
...
Do not accept add-ons. You want to know whether the assistant will hold a spot anyway. End once the assistant clearly says it cannot book or waitlist below minimum.`,
      metrics: [
        ...
        'The agent says the job is below the $175 minimum and $83 short.',
      ...
      tool_mocks: [
        {
          ...
          output: JSON.stringify({
            ...
            data: {
              ...
              missing_fields: [],
              caller_script:
                'The updated estimate is $92. That is $83 below our $175 minimum, so I cannot check appointment availability or finalize a booking yet.',
            },
          }),
        },
      ],
