      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <main className="container mx-auto max-w-4xl px-4 py-12">
          <Card className="overflow-hidden bg-white dark:bg-gray-800">
            {/* Hero Image */}
            <div className="relative h-[400px] w-full bg-gray-100 md:h-[500px] dark:bg-gray-700">
              <img
            ...
            <div className="p-6 md:p-8">
              <div className="mb-6 text-center">
                ...
                {sighting.city && sighting.state && (
                  <div className="mb-2 flex items-center justify-center gap-2 text-lg text-gray-600 dark:text-gray-300">
              ...
              <div className="mt-8 border-t pt-8 dark:border-gray-700">
                <div className="rounded-lg bg-gradient-to-br from-blue-50 to-green-50 p-6 text-center dark:from-blue-900/20 dark:to-green-900/20">
        ...
        {/* Footer */}
        <footer className="mt-16 border-t bg-white dark:border-gray-700 dark:bg-gray-800">
