              ...
              {filteredConversations.map((convo, i) => {
                ...
                return (
                  <div
                    ...
                    } ${isUnread ? 'bg-muted/60 dark:bg-white/[0.03]' : ''} hover:bg-muted/50 active:bg-muted/70 cursor-pointer dark:hover:bg-white/[0.05] dark:active:bg-white/10`}
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-baseline justify-between gap-2">
                        <span
                          className={`truncate text-sm ${
                            isUnread
                              ...
                              : 'text-foreground font-medium dark:text-slate-200'
                          }`}
                        >
                        ...
                        <span className="text-foreground flex-shrink-0 text-[11px] dark:text-slate-400">
                        ...
                        <p
                          className={`truncate text-xs ${
                            isUnread
                              ...
                              : 'text-foreground dark:text-slate-500'
                          }`}
                        >
                          {lastMessage
              ...
              <div className="flex-shrink-0 border-b p-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {selectedConvo.ops_customer_id && (
                          <span className="rounded-full bg-emerald-50 px-1.5 py-0.5 text-[10px] font-medium text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-400">
                            Scheduled Customer
                          </span>
                        )}
                      </div>
                ...
                {selectedConvo.customerContext &&
                  (selectedConvo.customerContext.email ||
                    ...
                    selectedConvo.customerContext.invoice) && (
                    <div className="border-border bg-muted/40 mb-3 space-y-1.5 rounded-lg border p-3 text-xs dark:border-white/10 dark:bg-white/[0.03]">
                      {selectedConvo.customerContext.email && (
                        <div className="flex items-center gap-2">
                      ...
                      {selectedConvo.customerContext.invoice && (
                        <div className="flex flex-wrap items-center gap-2 pt-0.5">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-1.5 rounded-md border border-emerald-600/30 bg-emerald-50 px-2 py-1 font-medium text-emerald-700 hover:bg-emerald-100 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-300 dark:hover:bg-emerald-500/20"
                            onClick={(e) => e.stopPropagation()}
                          >
                            View invoice
                              ...
                              className={`rounded px-1.5 py-0.5 text-[10px] font-medium capitalize ${
                                selectedConvo.customerContext.invoice
                                  ...
                                  : selectedConvo.customerContext.invoice
                                    ...
                                    : 'bg-muted text-muted-foreground dark:bg-slate-500/20 dark:text-slate-400'
                              }`}
                            >
                              ...
                              {(['venmo', 'cash', 'check'] as const).map(
                                (method) => (
                                  <button
                                    ...
                                    className="border-border bg-background text-foreground rounded border px-1.5 py-0.5 text-[10px] capitalize hover:border-emerald-600/50 hover:bg-emerald-50 hover:text-emerald-700 disabled:opacity-50 dark:border-slate-600 dark:bg-slate-700/50 dark:text-slate-300 dark:hover:border-emerald-500/50 dark:hover:bg-emerald-500/10 dark:hover:text-emerald-300"
                                  >
                                    {markingPaidInvoiceId ===
                                    selectedConvo.customerContext?.invoice?.id
                                      ? '…'
                      ...
                      <div className="mb-3 flex flex-wrap items-center gap-2">
                        ...
                        {!autoOn && (
                          <Button
                            size="sm"
                            variant="outline"
                            className="border-emerald-500/40 text-emerald-700 hover:border-emerald-500 hover:text-emerald-800 dark:text-emerald-400 dark:hover:border-emerald-400 dark:hover:text-emerald-300"
