...
export function buildCommercialSetupEmailDraft(params: {
  ...
  return {
    ...
    body: [
      ...
      `Your portal login email is ${params.contactEmail}. Use the secure button below for your first visit. It will sign you in and ask you to choose your own password. For security, the one-time link expires; if that happens, reply and we will send a new one.`,
      ...
      `Before we set up recurring service, please review and electronically sign the service agreement. This is similar to approving the estimate, but it also confirms the recurring scope, frequency, pricing, monthly invoicing, access expectations, and service terms.`,
